        ...
        <form action="backEnd" method="get">
            <div class="container">
                ...
                <div class="length range__slider" data-min="4" data-max="32">
                    ...
                    <input id="slider" type="range" name="sliderVal" min="4" max="32" value="16" />
                </div>

                <div class="settings">
                    <span class="settings__title field-title">settings</span>
                    <div class="setting">
                        <input type="checkbox" id="uppercase" name="C1" checked />
                        <label for="uppercase">Include Uppercase</label>
                    </div>
<!--                    <div class="setting">
                        <input type="checkbox" id="lowercase" name="C2" checked />
                        <label for="lowercase">Include Lowercase</label>
                    </div>-->
                    <div class="setting">
                        <input type="checkbox" id="number" name="C3"  checked />
                        <label for="number">Include Numbers</label>
                    </div>
                    <div class="setting">
                        <input type="checkbox" id="symbol" name="C4" />
                        <label for="symbol">Include Symbols</label>
                    </div>
                </div>

                    <button type="submit" class="btn generate" id="generate">Generate Password</button>
                    <button type="button" class="btn generate"id="generate" ><a href="check.jsp" class="f10">password Strength Check</a></button>
